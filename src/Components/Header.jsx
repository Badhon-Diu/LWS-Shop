...
export default function Header() {
  ...
  const { Search, carts } = useContext(ShopContext);
  return (
    <>
        ...
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <a href="#" className="hover:text-gray-500 transition-colors">
              ...
              {carts.length > 0 && (
                <span className="rounded-full text-sm absolute top-[50px] right-14  bg-[#12CF6F] text-white text-center p-[1px] w-[20px] h-[20px] ">
                  {carts.length}
                </span>
              )}
            </a>
